/**
 * @file /include/ros_common_robin_velocity_smoother/velocity_smoother_nodelet.hpp
 *
...
private:
  ...
  double speed_lim_vx, speed_lim_vy, accel_lim_vx, accel_lim_vy, decel_lim_vx, decel_lim_vy;
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<ros_common_robin_velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<ros_common_robin_velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(ros_common_robin_velocity_smoother::paramsConfig &config, uint32_t unused_level);
};

} // ros_common_robin_namespace velocity_smoother
